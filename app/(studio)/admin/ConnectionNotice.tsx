  ...
  return (
    ...
    >
      ...
      <p style={{ margin: '0 0 0.75rem' }}>
        El panel necesita una conexión permanente con los servidores de Sanity y este
        equipo o esta red no la deja abrir. Por eso puede quedarse en blanco o cargando sin
        parar. <strong>No es un problema de la web.</strong>
      </p>
      <p style={{ margin: 0, opacity: 0.85 }}>
        Suele ser un antivirus corporativo o un cortafuegos que inspecciona el tráfico
        (Sophos, McAfee y similares), o la red de una oficina. Para comprobarlo, abre esta
        misma dirección <strong>desde el móvil con datos</strong> o desde otra red: si ahí
        funciona, es eso. Si necesitas usarlo en este equipo, hay que pedir que se permita{' '}
